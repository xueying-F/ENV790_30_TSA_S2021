...
MEAN_seas <- meanf(y = BR_Temp_ts_deseas, h = 12)
checkresiduals(MEAN_seas) # ACF is highly dependency

SNAIVE_seas <- snaive(BR_Temp_ts_deseas, h=12)
checkresiduals(SNAIVE_seas)

SARIMA_autofit <- auto.arima(BR_Temp_ts_deseas)
checkresiduals(SARIMA_autofit) # ACF all in dotted blue lines, residuals not auto-related
