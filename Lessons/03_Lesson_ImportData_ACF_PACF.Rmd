...
nhydro <- ncol(raw_inflow_data)-2 # two columns are for date, remove date
...
colnames(raw_inflow_data)=c("Month","Year", "HP1", "HP2","HP3") #HP means hydro plants
...
ggplot(inflow_data, aes(x=my_date, y=Inflow)) +
            geom_line(aes(y=HP1,col="HP1"),group = 1) +
            geom_line(aes(y=HP2,col="HP2"),group = 2) +
            xlab("Time") +
