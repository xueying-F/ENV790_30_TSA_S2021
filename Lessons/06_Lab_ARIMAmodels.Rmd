...
decompose_ts_inflow_data <- decompose(ts_inflow_data[,"HP15"],"multiplicative")
plot(decompose_ts_inflow_data)
...
deseasonal_ts_inflow_data <- seasadj(decompose_ts_inflow_data) 
