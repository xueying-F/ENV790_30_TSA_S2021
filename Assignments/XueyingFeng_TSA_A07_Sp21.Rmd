...
#Make new plot
plot(full_ts, type="l", xlab="Year",ylab="Monthly inflow (m^3/s)")
...
plot(SARIMA_forecast, type="l", xlab="Year",ylab="Monthly inflow (m^3/s)")
...
```{r}
SSES_seas <- es(sample_ts,model="ZZZ",h=12,silent="none",holdout=FALSE)
plot(SSES_seas)
