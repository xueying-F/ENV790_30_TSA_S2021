...
```
>We can tell s=12 based on the spike at lag 12 is significant in ACF plot. It is hard to identify the order of seasonal components, because after lag 3, values in PACF are not significant；after lag 16, values in ACF are not significant. 
