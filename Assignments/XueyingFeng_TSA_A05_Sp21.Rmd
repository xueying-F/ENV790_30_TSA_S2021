...
```
> Order of non-seasonal is 3 based on the PACF plot. It is hard to identify the order of seasonal components, because after lag 3, values in PACF are not significant. Seasonal component cannot be identified.
